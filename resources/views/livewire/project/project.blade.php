<div class="max-w-2xl mx-auto py-16 sm:py-24 lg:max-w-none">
    ...
    <!-- Modal -->
    <div x-data="{ open: @entangle('openModal').defer }" @keydown.window.escape="open = false" x-show="open" class="relative z-10" aria-labelledby="modal-title" x-ref="dialog" aria-modal="true" style="display: none;">
